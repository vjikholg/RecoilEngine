...
* if the autohost uses [a dedicated instance (as opposed to headless)]({{< base_url >}}/docs/guides/getting-started/headless-and-dedicated/), players can send messages back to the autohost via whispers (`/wByNum 255 foo`) for non-sensitive data.
